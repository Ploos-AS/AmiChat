...
AmiChatResult AmiChat_ConversationAppend(AmiChatConversation *conversation,AmiChatMessage *message);
size_t AmiChat_ConversationMessageCount(const AmiChatConversation *conversation);
const AmiChatMessage *AmiChat_ConversationMessageAt(const AmiChatConversation *conversation,size_t index);
#ifdef __cplusplus
}
#endif
#endif
